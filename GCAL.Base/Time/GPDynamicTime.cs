...
{
    /// <summary>
    /// Returns difference between dynamic and universal time
    /// This can be only measured and predicted in real world.
    /// Uses reference values given in http://maia.usno.navy.mil/ser7/deltat.data
    /// Predictions are from ftp://maia.usno.navy.mil/ser7/deltat.preds
    /// This needs to be updated in the curse of time
    /// </summary>
    public class GPDynamicTime
    {
        // since 1800
        public static double[] epoch1 = new double[] {
            // start for 1800, jan
            // 2378496.500000
        ...
        public static double[] epoch2 = new double[] {
            // 1974 - 2014
            // 2442048.500000
        ...
        /// </summary>
        public static double[] epoch3 = new double[] {
            // start year 2014, jan
            // 2456658.500000
        ...
        public static double GetDeltaT(double julian)
        {
            double[] array;
            int index;
            ...
            {
                array = epoch3;
                index = Convert.ToInt32((julian - 2456658.5) * 4 / 360.25);
            }
            else if (julian > 2442048.500000)
            {
                ...
                array = epoch2;
                index = Convert.ToInt32((julian - 2442048.500000) * 12 / 360.25);
            }
            else
            {
                // before 1800 - 1973
                ...
                array = epoch1;
                index = Convert.ToInt32((julian - 2378496.500000) * 2 / 360.25);
            }
