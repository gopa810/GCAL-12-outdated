...
namespace GCAL.Dialogs
{
    public partial class GetDateTimeDlg : Form
    {
        ...
        public void SetUserInterfaceStrings()
        {
            ...
            this.label1.Text = GPStrings.getSharedStrings().getString(302);
            this.label2.Text = GPStrings.getSharedStrings().getString(7);
            this.label3.Text = GPStrings.getSharedStrings().getString(8);
            this.Text = GPStrings.getSharedStrings().getString(302);
