...
namespace GCAL.Dialogs
{
    public partial class GetPeriodYearsDlg : Form
    {
        ...
        public void SetUserInterfaceStrings()
        {
            ...
            this.label1.Text = GPStrings.getSharedStrings().getString(305);
            this.label2.Text = GPStrings.getSharedStrings().getString(259);
            this.label3.Text = GPStrings.getSharedStrings().getString(306);
            this.Text = GPStrings.getSharedStrings().getString(306);
        }
